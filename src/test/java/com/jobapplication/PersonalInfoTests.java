...
public class PersonalInfoTests {
	...
	public void submitFullApplication() throws InterruptedException {
		...
		String Appid=driver.findElement(By.xpath("//*[@id=\"richTxtMsgSpan\"]/label/div[8]")).getText();
		...
		String idStr=driver.findElement(By.xpath("(//td[@valign='top'])[3]")).getText();
